...
namespace Yooshina.Repository {
	public static class DBContextExtensions {
		...
		private static void RegiserConvention(this ModelBuilder modelBuilder) {
		...
		private static void RegisterCustomMappings(this ModelBuilder modelBuilder, IEnumerable<Type> typeToRegisters) {
